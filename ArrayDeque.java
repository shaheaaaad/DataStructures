...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == backingArray.length) {
            ...
            for (int i = 0; i < backingArray.length; i++) {
                int resettedIndex = mod((front + i), backingArray.length);
                arr[i + 1] = backingArray[resettedIndex];
            }
            front = 1;
            backingArray = arr;
    ...
    public void addLast(T data) {
        ...
        if (size == backingArray.length) {
            ...
            for (int i = 0; i < backingArray.length; i++) {
                int resettedIndex = mod(front + i, backingArray.length);
                arr[i] = backingArray[resettedIndex];
            }
            front = 0;
            backingArray = arr;
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Deque is Empty and cannot be removed from!");
        }
